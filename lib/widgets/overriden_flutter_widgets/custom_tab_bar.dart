...
///
/// {@tool dartpad}
/// This sample showcases nested Material 3 [CustomTabBar]s. It consists of a primary
/// [CustomTabBar] with nested a secondary [CustomTabBar]. The primary [CustomTabBar] uses a
/// [DefaultTabController] while the secondary [CustomTabBar] uses a [TabController].
///
...
class CustomTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// See also:
  ///
  ///  * [CustomTabBar], for a primary tab bar.
  ///  * [TabBarView], which displays page views that correspond to each tab.
  ///  * [TabController], which coordinates tab selection between a [CustomTabBar] and a [TabBarView].
  ///  * https://m3.material.io/components/tab-bar/overview, the Material 3
  ///     tab bar specification.
  ...
  ///
  /// When [isScrollable] is false, this will yield the same result as if [CustomTabBar] was wrapped
  ...
  ///
  /// If [ThemeData.useMaterial3] is true and [CustomTabBar] is used to create a
  ...
  /// Specifies the horizontal alignment of the tabs within a [CustomTabBar].
  ///
  /// If [CustomTabBar.isScrollable] is false, only [TabAlignment.fill] and
  /// [TabAlignment.center] are supported. Otherwise an exception is thrown.
  ///
  /// If [CustomTabBar.isScrollable] is true, only [TabAlignment.start], [TabAlignment.startOffset],
